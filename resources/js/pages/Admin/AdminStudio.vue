...
const title = computed(() => (props.is_edit ? 'Редактирование студии' : 'Создание студии'));

const submit = () => {
    if (props.is_edit && props.studio) {
        form.put(`/admin/studios/${props.studio.id}`);
        return;
    }
    form.post('/admin/studios');
};
</script>
